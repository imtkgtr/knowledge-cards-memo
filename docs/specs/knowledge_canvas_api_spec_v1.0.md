...
### 6.11 `POST /api/canvases/{canvasId}/thumbnail`
一覧用サムネイル更新。
...
### 6.12 `DELETE /api/canvases/{canvasId}/thumbnail`
一覧用サムネイル削除。

#### rules
- カードが 0 件になった場合に client から呼ぶ

#### response 204

---

### 6.13 `GET /api/canvases/{canvasId}/export`
JSON エクスポート。
